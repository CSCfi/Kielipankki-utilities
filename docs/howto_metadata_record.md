...
Please note the [specification](https://github.com/CSCfi/Kielipankki-Metax-bridge/blob/main/doc/mandatory-fields.md) for mandatory fields in COMEDI to achieve Metax compatibility. 
