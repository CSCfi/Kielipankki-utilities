...
If you are working on [CSC’s computing environment](https://urn.fi/urn:nbn:fi:lb-2026090301), do the following:

'git pull' to make sure your copy of the repository is up to date. Then change to the sub folder 'corp' and create a new folder for your corpus in here. Copy your conversion scripts to this folder.
