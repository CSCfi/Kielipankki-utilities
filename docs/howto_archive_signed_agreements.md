...
Note that you need a VPN connection to the University of Helsinki to be able to access the HFST server. In order to be able to connect to [CSC’s computing environment](https://urn.fi/urn:nbn:fi:lb-2026090301) from the HFST server, you can use e.g. sftp.
...
2. Fill in the required information, according to the agreement in question.
  ...
  - **Vastuualuekoodi:** Use H402 for the Digitaalisten ihmistieteiden osasto.
