...
```
# [ ] _*?DISCUSS*_ If the corpus seems to be "non-standard" in terms of legal issues or other uncertainties, discuss the corpus details in an internal meeting to check whether publication is even feasible in the Language Bank [Guidance on deciding whether a resource can be published | https://github.com/CSCfi/Kielipankki-utilities/blob/master/docs/howto_accept_resource_for_publishing.md]
