    ...
    def main(self, args, inf, ouf):
        ...
        def get_add_attrs_keyed(tsv_reader, line, attrs, linenr):
            ...
            if key in new_attr_values:
                ...
                msg_values = 'value "_"' if args.positional else 'empty values'
                self.warn(
                    ('No data for key {key} in {datafile}; using {msg_values}'
