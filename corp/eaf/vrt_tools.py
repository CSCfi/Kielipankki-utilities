...
def tokenize(string, maxlen, sent_id=None):
    ...
    # huomaa loppusuljetut tagit kuten <img src="..."/> tai <br/>
...
print(tokenize("""Vanhemmissa julkaisuissa reduplikoidut adjektiivit on tulkittu toisinaan myös
kontekstista riippuen yksikön tai monikon superlatiiveiksi: diĝir gal-gal-le-ne
'suurimmat jumalat'. Tähän on kuitenkin suhtauduttava varauksella, sillä
sumerin adjektiivien vertailumuotoja ei (esim. nyt) varmuudella tunneta (kts. Jagersma
2010: 283). Intensiivinen merkitys on kuitenkin teoriassa mahdollinen diĝir
gal-gal-le-ne 'todella suuret jumalat'.""", 1000))
