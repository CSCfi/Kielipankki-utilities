...
# Processing the Achemenet data for Korp

## Initial VRT format

The Achemenet had been converted to an initial VRT format by Aleksi
Sahala, one file per subcorpus, but the VRT data was post-processed in
several steps (on Puhti), with feedback from Tero Alstola.
